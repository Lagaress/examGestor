...
(9, 2, 'Esto es un enunciado', 'Resp1,resp2,resp3,resp4', 'resp1'),
(21, 1, 'Que es un arbol', 'No es nada, no existe, no lo se, una plan', 'una plan'),
...
(190, 5, 'Â¿De que color es el pelo de Pedro?', 'Azul,amarillo,rojo,no tiene', 'no tiene'),
...
(250, 5, '133', '123123312,123123,3123123,131213', '3'),
