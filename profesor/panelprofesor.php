...
<body>
    ...
    <br></br>
        ...
        <table style="text-align: center;">
            <tr> 
                <th>
                    <a href="operacionesProfesor/gestionPreguntas.php" class="gestionpreguntas">Gestion de preguntas</a>
                </th>
                <th>            
                    <a href="operacionesProfesor/gestionResultados.php" class="gestionresultados">Ver los resultados</a>
                </th>
                <th>
                    <?php
