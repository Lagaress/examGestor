...
if(isset($_POST['submited'])){
    ...
    if(query_db($username,$pass,$role)){
        ...
        $error = '<p class="error"> El nombre de usario y/o contraseña introducidos no pertenecen a un perfil de profesor valido </p>'; //Mensaje de error generico para evitar una posible enumeración de usuarios.
    }
